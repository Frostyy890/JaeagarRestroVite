...
import { AdminFormProps } from "../form/admin-form";

const SectionBox: React.FC<AdminFormProps> = ({ setIsOpen, setIsTypeEdit }) => {
  const { filteredDishes } = useAppSelector((state) => state.meals);
